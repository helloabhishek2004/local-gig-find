      ...
      <div className="flex flex-col h-screen bg-background overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-2 pb-24">
          <div className="max-w-sm mx-auto space-y-6">
            ...
            <Button onClick={() => navigate('/employer/post-job')} className="w-full btn-primary h-14 text-base font-semibold shadow-lg animate-fade-in">
              <Plus size={20} className="mr-2" />
              Post a New Job
            </Button>

            {/* Stats Grid */}
            <div className="grid grid-cols-2 gap-3 animate-fade-in" style={{
            animationDelay: '0.1s'
          }}>
              {stats.map((stat, index) => <button key={index} onClick={stat.onClick} className="card-enhanced p-4 ios-list-item group">
            ...
            animationDelay: '0.2s'
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <Button variant="ghost" size="sm" onClick={() => navigate('/employer/applications')} className="text-primary hover:bg-primary/10">
                  View All
                </Button>
              </div>
              ...
              <div className="space-y-3">
                ...
                return <button key={job.id} onClick={() => navigate('/employer/applications')} className="w-full card-enhanced p-4 ios-list-item text-left group">
            ...
            animationDelay: '0.3s'
              ...
              <div className="grid grid-cols-2 gap-3">
                <button onClick={() => navigate('/employer/applications')} className="card-enhanced p-4 ios-list-item group">
                ...
                <button onClick={() => navigate('/employer/chat')} className="card-enhanced p-4 ios-list-item group">
